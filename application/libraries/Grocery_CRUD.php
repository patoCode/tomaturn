...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_string_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' class='form-control border border-info' name='{$field_info->name}' type='text' value=\"$value\" $extra_attributes />";
		return $input;
	}
	...
	protected function get_text_input($field_info,$value)
	{
		...
		{
			$input = "<textarea id='field-{$field_info->name}' name='{$field_info->name}' class='form-control border border-info'>$value</textarea>";
		}
		return $input;
	}
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$datetime' maxlength='19' class='datetime-input form-control border border-info' />
	...
	protected function get_date_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$date' maxlength='10' class='datepicker-input form-control border border-info' />
